...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nome) || empty($email)) {
        ...
        $mensagem =
            "Erro: preenche o nome e o email.";
        ...
        try {
            ...
            if ($stmt_update->execute()) {
                ...
                $mensagem =
                    "Erro: não foi possível atualizar a conta.";
            }
